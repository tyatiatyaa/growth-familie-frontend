...
const createArticlesItemTemplate = (articles) => `
             <div class="mt-5">
             <div class="card box">
               <img src="${articles.img}" class="card-img-top">
                 <div class="card-body">
                 <h5 class="card-title">${articles.title}</h5>
                 <h6 class="card-subtitle mb-2 text-muted">${articles.category}</h6>
                 <p class="card-text">${articles.overview}</p>
                 <a href="#/article/${articles.slug}" class="btn position-absolute top-100 start-50 translate-middle fw-light">Read more...</a>
                 </div>
             </div>
`;

const createBudgetingItemTemplate = () => `
             <div class="mt-5">
             <div class="card box">
                 <div class="card-body">
                 <h5 class="card-title"><-- Nama brand --></h5>
                 <h6 class="card-subtitle mb-2 text-muted"><-- name --></h6>
                 <p class="card-text"> <-- quantity, features, price --></p>
                 <a href="#/<-- Link menuju Source -->" class="btn position-absolute top-100 start-50 translate-middle fw-light">Go to shop</a>
                 </div>
             </div>
`;
