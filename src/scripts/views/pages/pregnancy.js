...
const cardDetail = {
  async render() {
    ...
    <div class="budgeting-wrapper container-fluid py-5 mt-5 text-center">
      <h3 class="text-center mb-5"><u>What your needs during pregnancy?</u></h3>
      <!-- Button ini menuju ke halaman budgeting-pregnancy -->
      <a href="#" class="btn category rounded-pill mt-4">Take A Look At Here!</a>
    </div>
    `;
  },
